...
function addInitialRes() {
  ...
  for (var i = 0; i < num; i++) {
    ...
    inp.setAttribute("style", "text-align:center;margin:auto;float:left;background-color:white;color:black; padding:10px;width: 40px;height: 20px;");
  ...
  if (isNaN(num)) {
    ...
    for (var i = 0; i < num; i++) {
      ...
      inp1.setAttribute("style", "background-color:white;color:black;width:50px;text-align:center;margin:auto;float:left;border: 2px solid #609; padding:10px;width: 40px;height: 20px;");
      card.appendChild(inp1);
      d1.appendChild(card);
    }
    input.appendChild(d1);
    var d2 = document.createElement("div");
    d2.setAttribute("style", "width:100%;margin-left:10px;float:left;");
    var idk = document.createElement("br");
    ...
    for (var i = 0; i < num; i++) {
      ...
      inp2.setAttribute("style", "background-color:white;color:black;width:50px;text-align:center;margin:auto;float:left;border: 2px solid #609; padding:10px;width: 40px;height: 20px;");
...
function banker() {
  ...
  but.setAttribute("style", "width:200px;text-align:center;margin:auto;float:left;");
  operation.appendChild(d3);
